...
@Mod("github")
public class GithubMod {
	public static final Logger LOGGER = LogManager.getLogger(GithubMod.class);
	public static final String MODID = "github";

	public GithubMod(IEventBus modEventBus) {
